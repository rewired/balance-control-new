...
## 2026-02-11 — Task 0014: Canonical effect resolver pipeline
- @bc/rules: added EffectDescriptor and createResolver(resolveEffect) implementing AGENTS §3.5 order (ContextTile ? prohibitions ? cost increases ? output modifiers ? floors ? atomic execute) with Start Committee immunity (AGENTS §3.7).
